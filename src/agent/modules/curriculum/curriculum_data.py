...
from .models import (
    Competency, LearningModule, CEFRLevel, SkillType, CompetencyType,
    ...
    def get_a1_competencies() -> List[Competency]:
        ...
        return [
            ...
            Competency(
                ...
                key_vocabulary=[
                    "name", "age", "from", "live", "hello", "goodbye", "please", "thank you",
                    "yes", "no", "excuse me", "sorry"
                ],
                grammar_points=[
            ...
            Competency(
                ...
                key_vocabulary=[
                    "eat", "drink", "sleep", "work", "study", "home", "family", "friend",
                    "food", "water", "money", "time", "day", "night", "good", "bad",
            ...
            Competency(
                ...
                key_vocabulary=[
                    "wake up", "get up", "have breakfast", "go to work", "come home",
                    "watch TV", "go to bed", "usually", "always", "sometimes", "never"
                ],
                grammar_points=[
            ...
            Competency(
                ...
                key_vocabulary=[
                    ...
                    "aunt", "uncle", "cousin", "wife", "husband", "daughter", "son",
                    "parents", "children", "married", "single"
                ],
                grammar_points=[
            ...
            Competency(
                ...
                learning_objectives=[
                    ...
                    "Use basic date expressions"
                ],
                key_vocabulary=[
                    "one", "two", "three", "ten", "twenty", "hundred",
    ...
    def get_a2_competencies() -> List[Competency]:
        ...
        return [
            ...
            Competency(
                ...
                key_vocabulary=[
                    "yesterday", "last week", "last year", "ago", "when",
                    "went", "saw", "came", "did", "was", "were", "had"
                ],
                grammar_points=[
                    "Regular verbs + ed",
            ...
            Competency(
                ...
                key_vocabulary=[
                    ...
                    "chicken", "beef", "fish", "vegetables", "rice", "pasta",
                    "coffee", "tea", "juice", "water", "beer", "wine",
                    "delicious", "tasty", "spicy", "sweet", "sour"
                ],
                grammar_points=[
            ...
            Competency(
                ...
                key_vocabulary=[
                    "airport", "hotel", "station", "bus", "train", "taxi",
                    "left", "right", "straight", "turn", "corner", "street",
                    "near", "far", "next to", "opposite", "between"
                ],
                grammar_points=[
    ...
    def get_b1_competencies() -> List[Competency]:
        ...
        return [
            ...
            Competency(
                ...
                key_vocabulary=[
                    "will", "going to", "plan", "hope", "expect", "predict",
                    "probably", "definitely", "maybe", "perhaps", "future", "goal"
                ],
                grammar_points=[
            ...
            Competency(
                ...
                key_vocabulary=[
                    "job", "career", "profession", "salary", "manager", "colleague",
                    "meeting", "deadline", "project", "responsibility", "experience",
                    "qualification", "interview", "promotion", "resign", "retire"
                ],
                grammar_points=[
